# Desafio Software Engineer, Back-end - [Pagar.me](https://github.com/pagarme/vagas/tree/master/desafios/software-engineer-backend)

O desafio proposto é desenvolver uma versão super simplificada de um Payment Service Provider (PSP) como o Pagar.me aprender um pouco mais sobre como funcionam pagamentos no Brasil.
...
![Database Schema](./diagram.drawio.svg)
